...
export class ZoomService {
  ...
  getZoomCalendarToken(code: any){
    ...
    return this.http.post<any>("https://zoom.us/oauth/token?grant_type="+cal_data.toString(), cal_data.toString(), {headers: new HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded')})
  }
}
